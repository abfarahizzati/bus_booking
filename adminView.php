    ...
    while($row = $result->fetch_array()){
           echo '
              <tr>
                ...
                <td><a href="updateAdmin.php?update=1&id='.$row["id"].'?'.$row["email"].'">Edit<span class="glyphicon glyphicon-edit"></span></a></td>
              </tr>
            ';
        }
        echo "</table>";
...
<br><br>
<form>
  <input type="button" class="btn btn-info" value="Back" onclick="location.href ='welcomeAdmin.php'">
